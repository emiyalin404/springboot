...
import net.javaguides.model.Transaction;
...
import static net.javaguides.util.Constant.EXTENSION_JRXML;
import static net.javaguides.util.Constant.FOLDER_PATH_REPORT_DYNAMIC;
